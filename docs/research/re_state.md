...
Дата исследования: 2026-09-17. Все ссылки ниже реально открывались или были получены в выдаче поиска в этой сессии. Там, где факт взят только из сниппета поиска (а не с открытой страницы), это помечено.
