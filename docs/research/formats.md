...
Примечание: TCRF не использован как источник. Факты про `.tro/.trp/.bso/.bsp/crsmap` взяты из SUBMANIAC и Modding Hub.
